    ...
    <TheCard
        ...
        <div class="p-2">
            <div class="flex items-center justify-between mb-3">
                <div>
                    <h3 class="text-xl font-semibold text-gray-800 dark:text-gray-200 tracking-tight">カテゴリー別予算</h3>
                    <p class="text-sm text-gray-600 dark:text-gray-400 mt-2">各カテゴリーの月間予算上限を設定しています</p>
                </div>
                <button @click="onClickShow"
                    class="text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200 transition-colors duration-300 transform hover:rotate-180">
